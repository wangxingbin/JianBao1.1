...
/**
 * Created by 孙贝贝 on 2016/12/26.
 */

public class ResgiterUtils {
    public static PhotoPostUtils.GetRegisterData data;
    public interface GetRegisterData{
        void setRegisterData(Object o);
    }
    public static  void  getData(PhotoPostUtils.GetRegisterData data1){
        data= data1;
    }
    ...
    public static void upLoad( final Context context, String  path, HashMap<String ,String> map, final Type clas){
