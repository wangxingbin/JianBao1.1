...
public class SSLBAdapter extends RecyclerView.Adapter<SSLBAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        private final TextView id_price,id_title;

        public MyViewHolder(View itemView) {
            super(itemView);
            id_sdv = (SimpleDraweeView) itemView.findViewById(R.id.id_sdv);
            id_price = (TextView) itemView.findViewById(R.id.tv_jiaqian);
//            id_time = (TextView) itemView.findViewById(R.id.tv);
            id_title = (TextView) itemView.findViewById(R.id.tv_biaoti);
        }
    }


    public SSLBAdapter.OnItemClickListener mListener;
    ...
    public void setOnClickListener(SSLBAdapter.OnItemClickListener listener) {
